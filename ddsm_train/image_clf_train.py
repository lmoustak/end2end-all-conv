...
from dm_keras_ext import (load_dat_ram, do_2stage_training, DMFlush,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--resume-from",
                        ...
                        type=str,
                        default=None)
    parser.add_argument("--no-resume-from",
                        dest="resume_from",
                        action="store_const",
                        const=None)
    parser.add_argument("--img-size",
                        ...
                        type=int,
                        default=[1152, 896])
    parser.add_argument("--img-scale",
                        "-ic",
                        dest="img_scale",
                        type=float,
                        default=None)
    parser.add_argument("--no-img-scale",
                        "-nic",
                        dest="img_scale",
                        action="store_const",
                        const=None)
    ...
    parser.add_argument("--block-type",
                        ...
                        type=str,
                        default="resnet")
    parser.add_argument("--top-depths",
                        dest="top_depths",
                        nargs='+',
                        type=int,
                        default=[512, 512])
    parser.add_argument("--top-repetitions",
                        dest="top_repetitions",
                        nargs='+',
                        type=int,
                        default=[3, 3])
    parser.add_argument("--bottleneck-enlarge-factor",
                        dest="bottleneck_enlarge_factor",
                        type=int,
                        default=4)
    parser.add_argument("--add-heatmap",
                        dest="add_heatmap",
                        action="store_true")
    ...
    parser.add_argument("--avg-pool-size",
                        dest="avg_pool_size",
                        nargs=2,
                        type=int,
                        default=[7, 7])
    ...
    parser.add_argument("--add-shortcut",
                        dest="add_shortcut",
                        action="store_true")
    ...
    parser.add_argument("--hm-strides",
                        dest="hm_strides",
                        nargs=2,
                        type=int,
                        default=[1, 1])
    parser.add_argument("--hm-pool-size",
                        dest="hm_pool_size",
                        nargs=2,
                        type=int,
                        default=[5, 5])
    ...
    parser.add_argument("--top-layer-nb",
                        dest="top_layer_nb",
                        type=int,
                        default=None)
    parser.add_argument("--no-top-layer-nb",
                        dest="top_layer_nb",
                        action="store_const",
                        const=None)
    ...
    parser.add_argument("--all-layer-epochs",
                        dest="all_layer_epochs",
                        type=int,
                        default=20)
    parser.add_argument("--load-val-ram",
                        dest="load_val_ram",
                        action="store_true")
    ...
    parser.add_argument("--hidden-dropout",
                        ...
                        type=float,
                        default=.0)
    parser.add_argument("--weight-decay2",
                        "-wd2",
                        dest="weight_decay2",
                        type=float,
                        default=.0001)
    parser.add_argument("--hidden-dropout2",
                        "-hd2",
                        dest="hidden_dropout2",
                        type=float,
                        default=.0)
    parser.add_argument("--optimizer", dest="optim", type=str, default="sgd")
    parser.add_argument("--init-learningrate",
                        "-ilr",
                        dest="init_lr",
                        type=float,
                        default=.01)
    ...
    run_opts = dict(patch_model_state=args.patch_model_state,

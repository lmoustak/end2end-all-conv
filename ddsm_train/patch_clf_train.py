...
from dm_keras_ext import (get_dl_model, load_dat_ram, do_3stage_training,
                          DMFlush)
...
def run(train_dir,
    ...
    if net != 'yaroslav' and net != 'custom':
        dup_3_channels = True
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--nb-epoch",
                        ...
                        type=int,
                        default=5)
    parser.add_argument("--top-layer-epochs",
                        dest="top_layer_epochs",
                        type=int,
                        default=10)
    ...
    parser.add_argument("--nb-init-filter",
                        "-nif",
                        dest="nb_init_filter",
                        type=int,
                        default=32)
    parser.add_argument("--init-filter-size",
                        "-ifs",
                        dest="init_filter_size",
                        type=int,
                        default=5)
    parser.add_argument("--init-conv-stride",
                        "-ics",
                        dest="init_conv_stride",
                        type=int,
                        default=2)
    parser.add_argument("--max-pooling-size",
                        "-mps",
                        dest="pool_size",
                        type=int,
                        default=2)
    parser.add_argument("--max-pooling-stride",
                        "-mpr",
                        dest="pool_stride",
                        type=int,
                        default=2)
    ...
    parser.add_argument("--inp-dropout",
                        "-id",
                        dest="inp_dropout",
                        type=float,
                        default=.0)
    ...
    parser.add_argument("--use-pretrained",
                        dest="use_pretrained",
                        action="store_true")
    parser.add_argument("--no-use-pretrained",
                        dest="use_pretrained",
                        action="store_false")
    ...
    parser.add_argument("--no-top-layer-nb",
                        ...
                        action="store_const",
                        const=None)
    parser.add_argument("--top-layer-multiplier",
                        dest="top_layer_multiplier",
                        type=float,
                        default=.1)
    ...
    run_opts = dict(img_size=args.img_size,
